 ...
 */
final class Version20230825081542 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce DROP professeur_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce ADD professeur_id INT DEFAULT NULL');
    }
}
