 ...
 */
final class Version20230818163154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce CHANGE prof_id prof_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce CHANGE prof_id prof_id INT NOT NULL');
    }
}
